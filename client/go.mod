module github.com/lebaoworks/gosys/client

go 1.17

replace github.com/lebaoworks/gosys/service => ../service

require (
	github.com/lebaoworks/gosys/service v0.0.0-00010101000000-000000000000
